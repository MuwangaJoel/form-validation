...
<body>
<!--<img src="" alt="" height="100" width="250" style="margin-top: -54px;">
...
<form action="login.php" method="post">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 15px #000; color:#fff;"><center>Online Fruit Shop</center></font>
		<br>		
